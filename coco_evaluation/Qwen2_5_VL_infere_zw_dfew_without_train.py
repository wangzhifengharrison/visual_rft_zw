...
LOG_FILE = "/home/zhe030/zhe030/ZFW/Visual-RFT/logs/inference_dfew_without_train_rank_{rank}.log"
logging.basicConfig(
    level=logging.INFO,
...
def run():
    ...
    output_path = f'/home/zhe030/zhe030/ZFW/Visual-RFT/logs/dfew_without_train_each_predictions_rank_{rank}.jsonl'
            ...
            try:
                ...
                if bbox_list==None or type(bbox_list[0])==str:
                    ...
                    for bbox in bbox_list:
                        ...
                        with open('/home/zhe030/zhe030/ZFW/Visual-RFT/predictions/each_predictions_dfew_without_train.jsonl', 'a') as f:
    ...
    out_csv = f"/home/zhe030/zhe030/ZFW/Visual-RFT/predictions/dfew_without_train_csv/dfew_without_train_inference_results_rank_{rank}.csv"
...
def main():
    ...
    if multiprocess:
        ...
        ### save path
        with open('/home/zhe030/zhe030/ZFW/Visual-RFT/predictions/prediction_results_dfew_without_train.json', 'w') as json_file:
