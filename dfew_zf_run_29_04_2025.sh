...
#PBS -l wd
#PBS -j oe
#PBS -o logs/run_log_$PBS_JOBID_640.log
...
# Launch script
LAUNCH_SCRIPT=/scratch/kf09/zw4360/Visual-RFT/dfew_zf_run_2_29_04_2025.sh
...
# qsub dfew_zf_run_29_04_2025.sh to run the experiment