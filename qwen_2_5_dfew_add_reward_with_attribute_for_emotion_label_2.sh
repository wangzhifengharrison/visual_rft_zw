...
# Application script
APPLICATION_SCRIPT=/scratch/kf09/zw4360/Visual-RFT/src/virft/src/open_r1/grpo_qwen_2_5_dfew_reward_add_reward_with_label_for_emotion_label_change_confidence_use_score_not_bertscore.py #grpo_qwen_2_5_dfew.py  #grpo.py 
...
# Logging
exec > "logs/log_${1}_${2}_qwen2.5_3b_dfew_usecache_false_dfew_clip_offload_add_reward_with_attribute_for_emotion_label_2000.out" 2>&1
