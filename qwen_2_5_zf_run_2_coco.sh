...
export SAVE_PATH=./share_models/Qwen2.5-VL-3B-Instruct_GRPO_coco_base65_dataset_change_back_grpo_train    ### save path
export DEBUG_MODE="true" # Enable Debug if you want to see the rollout of model during RL
export LOG_PATH="./debug_log_qwen2.5_3b_GRPO_coco_base65cate_6k_use_cache_false_1.txt"
# Set execute permission
chmod u+x ${APPLICATION_SCRIPT}
# Logging
exec > "logs/log_${1}_${2}_qwen2.5_3b_coco_original_usecache_false_1.out" 2>&1
...
WANDB_MODE=offline torchrun \
    ...
    --run_name Qwen2.5-VL-3B_GRPO_coco_base_65_dataset_change_back_grpo_set \
    --save_steps 20 \
