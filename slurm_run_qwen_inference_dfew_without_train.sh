...
APPLICATION_SCRIPT=/home/zhe030/zhe030/ZFW/Visual-RFT/coco_evaluation/Qwen2_5_VL_infere_zw_dfew_without_train.py
...
export LOG_PATH="./slurm_log_qwen2.5_3b_GRPO_dfew_without_train_0_6_mean_inference.txt"
...
# Logging
exec > "logs/log_inference_qwen2.5_3b_dfew_without_train.out" 2>&1
...
WANDB_MODE=offline srun torchrun \
    ...
    --max_pixels 401408 \
    --num_train_epochs 1 \
    --run_name Qwen2.5-VL-3B_GRPO_dfew_without_train_inference \
    --save_steps 40 \
    --save_only_model true \
    --num_generations 4

####  sbatch slurm_run_qwen_inference_dfew_without_train.sh
####  squeue -u zhe030
