...
export CKPT_PATH=./share_models/Qwen2.5-VL-7B-Instruct
export SAVE_PATH=./share_models/Qwen2.5-VL-7B-Instruct_GRPO_dfew_train_slurm
export DEBUG_MODE="true"
export LOG_PATH="./slurm_log_qwen2.5_7b_GRPO_dfew_0_6_mean.txt"
...
# Logging
exec > "logs/log_qwen2.5_7b_dfew_0_6_mean_2.out" 2>&1
...
WANDB_MODE=offline srun torchrun \
    ...
    --max_pixels 401408 \
    --num_train_epochs 1 \
    --run_name Qwen2.5-VL-7B_GRPO_dfew_add_reward_for_emotion_label_all \
    --save_steps 40 \
    --save_only_model true \
    --num_generations 4


####  sbatch slurm_run_qwen_train_7B.sh
####  squeue -u zhe030