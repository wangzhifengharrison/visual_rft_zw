...
export SAVE_PATH=./share_models/Qwen2-VL-2B-Instruct_GRPO_coco_base65_dataset_change_back_grpo_train_v2    ### save path
# Set execute permission
chmod u+x ${APPLICATION_SCRIPT}
# Logging
exec > "logs/log_${1}_${2}_v2.out" 2>&1
...
WANDB_MODE=offline torchrun \
    ...
    --max_pixels 401408 \
    --num_train_epochs 3 \
    --run_name Qwen2-VL-2B_GRPO_coco_base_65_dataset_change_back_grpo_set_v2 \
    --save_steps 100 \
